...
base_params = {
  ...
  "summaries": ['learning_rate', 'variables', 'gradients', 'larc_summaries',
                'variable_norm', 'gradient_norm', 'global_gradient_norm', 'ctc', 'triplet'],
  ...
  "loss": CTCLoss,
  "loss_params": {},
  "load_model": "/GeneralizedKWS/OpenSeq_pretrained/ds2_large",
}
...
train_params = {
  ...
  "data_layer_params": {
    ...
    "dataset_files": [
    "/GeneralizedKWS/training_files/timit_train.csv"
    ],
    "max_duration": 16.7,
    "shuffle": True,
  },
...
eval_params = {
  ...
  "data_layer_params": {
    ...
    "vocab_file": "open_seq2seq/test_utils/toy_speech_data/vocab.txt",
    "dataset_files": [
      "/GeneralizedKWS/training_files/timit_test.csv",
    ],
    "shuffle": False,
  },
} 

...
def optimize_loss(loss,
  ...
  if summaries is None:
    summaries = ["learning_rate", "global_gradient_norm", "loss_scale",'ctc','mse','triplet']
  else:
  ...
  if "ctc" in summaries:
    tf.summary.scalar("ctc", ctc)

  # if "mse" in summaries:
  #   tf.summary.scalar("mse", mse)
  
  if "triplet" in summaries:
    tf.summary.scalar("triplet", triplet)
  ...
  with tf.variable_scope("Loss_Optimization"):
    ...
    # Compute gradients.
    print("list of variables to optimize: ", var_list)

...
base_params = {
  ...
  "logdir": "",
'specific_checkpoint':"/GeneralizedKWS/training_output/logdir/model.ckpt-227000",
...
eval_params = {
  ...
  "data_layer_params": {
    ...
    "vocab_file": "open_seq2seq/test_utils/toy_speech_data/vocab.txt",
    "dataset_files": [
"/GeneralizedKWS/evaluation_codes/test_files/multiview/timit_test.csv" #replace
    ],
    "shuffle": False,
  },
} 
